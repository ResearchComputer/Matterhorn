...
class LaunchStage:
    ...
    def __init__(self, controller: Controller, batch_script: str) -> None:
        self._controller = controller
        self._batch_script = batch_script
        self._batch_job: Optional[BaseBatchJob] = None
    ...
    def get_batch_job(self) -> BaseBatchJob:
        return cast(BaseBatchJob, self._batch_job)
...
class WatchStage:
    ...
    def __init__(
        ...
        self._job_status: Optional[BaseJobStatus] = None
    ...
    def _get_callback(self, ui: UI) -> JobStatusCallback:
        def callback(new_status: BaseJobStatus) -> None:
...
class StatusStage:
    ...
    def __init__(self, controller: Controller, jobid: str) -> None:
        self._controller = controller
        self._jobid = jobid
...
class CancelStage:
    ...
    def __init__(self, controller: Controller, jobid: str):
        self._controller = controller
        self._jobid = jobid
